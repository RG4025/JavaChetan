...
<body class="">
	<form method="get" action="">
			...
			<div class="row">
					<div class="col-lg-6 col-md-3 mx-5">
							<p class="text-center">UserName
							<p><input type="text" name="input1">
							<p class="text-center">Password
							<p><input type="password" name="input2">
							<div class="d-flex">
									<a href="Appoinment.jsp"class="btn btn-warning mx-3">Login</a>
									<a href="PatientRegistration.jsp"  class="btn btn-primary mx-3">Register</a>
							</div>
					</div>
			</div>
	</section>
